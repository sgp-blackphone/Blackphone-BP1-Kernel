...
static struct cpu_cvb_dvfs cpu_cvb_dvfs_table[] = {
	{
		...
		.cvb_table = {
			...
			/*{ 204000, { 2026332,  -103723,   2073}, {  821218,    0,    0} },*/
			{ 306000, { 2063977,  -105003,   2073}, {  828605,    0,    0} },
			/*{ 408000, { 2103089,  -106293,   2073}, {  837369,    0,    0} },*/
			{ 510000, { 2143659,  -107573,   2073}, {  848048,    0,    0} },
			/*{ 612000, { 2185697,  -108863,   2073}, {  860104,    0,    0} },
			{ 714000, { 2229194,  -110143,   2073}, {  874075,    0,    0} },
			{ 816000, { 2274155,  -111423,   2073}, {  889692,    0,    0} },
			{ 918000, { 2320582,  -112713,   2073}, {  906686,    0,    0} },*/
			{1020000, { 2368468,  -113993,   2073}, {  925595,    0,    0} },
			{1122000, { 2417817,  -115273,   2073}, {  946150,    0,    0} },
			/*{1224000, { 2468634,  -116563,   2073}, {  968083,    0,    0} },
			{1326000, { 2520910,  -117843,   2073}, {  991929,    0,    0} },*/
			{1428000, { 2574652,  -119133,   2073}, { 1017154,    0,    0} },
			/*{1530000, { 2629854,  -120413,   2073}, { 1300000,    0,    0} },*/
			{1632000, { 2686519,  -121693,   2073}, { 1300000,    0,    0} },
			{1734000, { 2744651,  -122983,   2073}, { 1300000,    0,    0} },
			{1836000, { 2804242,  -124263,   2073}, { 1300000,    0,    0} },
			{1938000, { 2865296,  -125543,   2073}, { 1300000,    0,    0} },
			{2014500, { 2911742,  -126503,   2073}, { 1300000,    0,    0} },
			{      0, {      0,      0,   0}, {      0,    0,    0} },
		},
...
static const int core_millivolts[MAX_DVFS_FREQS] = {
	800, 825, 850, 900, 950, 1000, 1050, 1100, 1150, 1200, 1230};
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("cpu_lp",   1,  1, 1, KHZ,      249600, 249600, 364800, 460800, 556800, 633600, 691200, 729600, 729600, 729600, 729600),

#ifndef CONFIG_TEGRA_DUAL_CBUS
	CORE_DVFS("3d",       0,  0, 1, KHZ,      153600, 153600, 230400, 307200, 384000, 499200, 556800, 600000, 600000, 600000, 600000),
	CORE_DVFS("2d",       0,  0, 1, KHZ,      153600, 153600, 230400, 307200, 384000, 499200, 556800, 600000, 600000, 600000, 600000),
	CORE_DVFS("epp",      0,  0, 1, KHZ,      153600, 153600, 230400, 307200, 384000, 499200, 556800, 600000, 600000, 600000, 600000),
	CORE_DVFS("3d",       0,  1, 1, KHZ,      192000, 192000, 268800, 345600, 384000, 499200, 556800, 600000, 600000, 600000, 600000),
	CORE_DVFS("2d",       0,  1, 1, KHZ,      192000, 192000, 268800, 345600, 384000, 499200, 556800, 600000, 600000, 600000, 600000),
	CORE_DVFS("epp",      0,  1, 1, KHZ,      192000, 192000, 268800, 345600, 384000, 499200, 556800, 600000, 600000, 600000, 600000),
	CORE_DVFS("3d",       1,  1, 1, KHZ,      153600, 153600, 230400, 307200, 384000, 499200, 556800, 595200, 652800, 691200, 710400),
	CORE_DVFS("2d",       1,  1, 1, KHZ,      153600, 153600, 230400, 307200, 384000, 499200, 556800, 595200, 652800, 691200, 710400),
	CORE_DVFS("epp",      1,  1, 1, KHZ,      153600, 153600, 230400, 307200, 384000, 499200, 556800, 595200, 652800, 691200, 710400),
#endif
	CORE_DVFS("se",       0,  0, 1, KHZ,      115200, 115200, 192000, 249600, 326400, 364800, 441600, 480000, 518400, 518400, 518400),
	CORE_DVFS("vde",      0,  0, 1, KHZ,      115200, 115200, 192000, 249600, 326400, 364800, 441600, 480000, 518400, 518400, 518400),
	CORE_DVFS("se",       0,  1, 1, KHZ,      153600, 153600, 211200, 288000, 345600, 403200, 460800, 499200, 518400, 518400, 518400),
	CORE_DVFS("vde",      0,  1, 1, KHZ,      153600, 153600, 211200, 288000, 345600, 403200, 460800, 499200, 518400, 518400, 518400),
	CORE_DVFS("se",       1,  1, 1, KHZ,      115200, 115200, 192000, 249600, 326400, 364800, 441600, 480000, 518400, 518400, 518400),
	CORE_DVFS("vde",      1,  1, 1, KHZ,      115200, 115200, 192000, 249600, 326400, 364800, 441600, 480000, 518400, 518400, 518400),

	CORE_DVFS("msenc",    0,  0, 1, KHZ,       68000,  68000, 102000, 136000, 204000, 204000, 204000, 384000, 384000, 384000, 384000),
	CORE_DVFS("msenc",    0,  1, 1, KHZ,       81600,  81600, 136000, 204000, 204000, 204000, 204000, 384000, 384000, 384000, 384000),
	CORE_DVFS("msenc",    1,  1, 1, KHZ,       68000,  68000, 102000, 136000, 204000, 204000, 204000, 384000, 384000, 384000, 384000),

	CORE_DVFS("tsec",     0,  0, 1, KHZ,      136000, 136000, 204000, 204000, 408000, 408000, 408000, 408000, 408000, 408000, 408000),
	CORE_DVFS("tsec",     0,  1, 1, KHZ,      136000, 136000, 204000, 384000, 408000, 408000, 408000, 408000, 408000, 408000, 408000),
	CORE_DVFS("tsec",     1,  1, 1, KHZ,      136000, 136000, 204000, 204000, 408000, 408000, 408000, 408000, 408000, 408000, 408000),

	CORE_DVFS("host1x",   0,  0, 1, KHZ,      102000, 102000, 102000, 204000, 204000, 204000, 204000, 384000, 408000, 408000, 408000),
	CORE_DVFS("host1x",   0,  1, 1, KHZ,      136000, 136000, 136000, 204000, 204000, 204000, 384000, 384000, 408000, 408000, 408000),
	CORE_DVFS("host1x",   1,  1, 1, KHZ,      102000, 102000, 102000, 204000, 204000, 204000, 204000, 384000, 408000, 408000, 408000),

	CORE_DVFS("vi",      -1, -1, 1, KHZ,      136000, 136000, 204000, 204000, 408000, 408000, 408000, 408000, 408000, 408000, 408000),
	CORE_DVFS("isp",     -1, -1, 1, KHZ,      136000, 136000, 204000, 204000, 408000, 408000, 408000, 408000, 408000, 408000, 408000),

	CORE_DVFS("sbus",     0,  0, 1, KHZ,      102000, 102000, 102000, 102000, 102000, 204000, 384000, 384000, 408000, 408000, 408000),
	CORE_DVFS("sbus",     0,  1, 1, KHZ,      136000, 136000, 136000, 204000, 204000, 204000, 384000, 384000, 408000, 408000, 408000),
	CORE_DVFS("sbus",     1,  1, 1, KHZ,      102000, 102000, 102000, 102000, 102000, 204000, 384000, 384000, 408000, 408000, 408000),

	CORE_DVFS("emc",     -1, -1, 1, KHZ,           1,      1,      1,      1,      1,      1,      1,1066000,1066000,1066000,1066000),

#ifdef CONFIG_TEGRA_DUAL_CBUS
	CORE_DVFS("c3bus",    0,  0, 1, KHZ,      115200, 115200, 192000, 249600, 326400, 364800, 441600, 480000, 518400, 518400, 518400),
	CORE_DVFS("c3bus",    0,  1, 1, KHZ,      153600, 153600, 211200, 288000, 345600, 403200, 460800, 499200, 518400, 518400, 518400),
	CORE_DVFS("c3bus",    1,  1, 1, KHZ,      115200, 115200, 192000, 249600, 326400, 364800, 441600, 480000, 518400, 518400, 518400),
#else
	CORE_DVFS("cbus",     0,  0, 1, KHZ,      115200, 115200, 192000, 249600, 326400, 364800, 441600, 480000, 518400, 518400, 518400),
	CORE_DVFS("cbus",     0,  1, 1, KHZ,      153600, 153600, 211200, 288000, 345600, 403200, 460800, 499200, 518400, 518400, 518400),
	CORE_DVFS("cbus",     1,  1, 1, KHZ,      115200, 115200, 192000, 249600, 326400, 364800, 441600, 480000, 518400, 518400, 518400),
#endif
	/* Core voltages (mV):		             800,    825,    850,    900,    950,   1000,   1050,   1100,   1150,   1200,   1230 */
	/* Clock limits for I/O peripherals */
	CORE_DVFS("cilab",  -1, -1, 1, KHZ,       102000, 102000, 102000, 102000, 102000, 102000, 114700, 136000, 136000, 136000, 136000),
	CORE_DVFS("cilcd",  -1, -1, 1, KHZ,       102000, 102000, 102000, 102000, 102000, 102000, 114700, 136000, 136000, 136000, 136000),
	CORE_DVFS("cile",   -1, -1, 1, KHZ,       102000, 102000, 102000, 102000, 102000, 102000, 114700, 136000, 136000, 136000, 136000),
	CORE_DVFS("dsia",  -1, -1, 1, KHZ,        252000, 252000, 431000, 431000, 431000, 431000, 431000, 431000, 431000, 431000, 431000),
	CORE_DVFS("dsib",  -1, -1, 1, KHZ,        252000, 252000, 431000, 431000, 431000, 431000, 431000, 431000, 431000, 431000, 431000),
	CORE_DVFS("hdmi",   -1, -1, 1, KHZ,       111300, 111300, 111300, 111300, 135600, 173200, 212300, 270000, 270000, 270000, 270000),

	CORE_DVFS("pll_m",   0,  0, 1, KHZ,       408000, 408000, 667000, 800000,1066000,1066000,1066000,1066000,1066000,1066000,1066000),
	CORE_DVFS("pll_c",   0,  0, 1, KHZ,       408000, 408000, 667000, 800000,1066000,1066000,1066000,1066000,1066000,1066000,1066000),
	CORE_DVFS("pll_c2",  0,  0, 1, KHZ,       408000, 408000, 667000, 800000,1066000,1066000,1066000,1066000,1066000,1066000,1066000),
	CORE_DVFS("pll_c3",  0,  0, 1, KHZ,       408000, 408000, 667000, 800000,1066000,1066000,1066000,1066000,1066000,1066000,1066000),
	CORE_DVFS("pll_m",   0,  1, 1, KHZ,       408000, 408000, 667000, 800000,1066000,1066000,1066000,1066000,1066000,1066000,1066000),
	CORE_DVFS("pll_c",   0,  1, 1, KHZ,       408000, 408000, 667000, 800000,1066000,1066000,1066000,1066000,1066000,1066000,1066000),
	CORE_DVFS("pll_c2",  0,  1, 1, KHZ,       408000, 408000, 667000, 800000,1066000,1066000,1066000,1066000,1066000,1066000,1066000),
	CORE_DVFS("pll_c3",  0,  1, 1, KHZ,       408000, 408000, 667000, 800000,1066000,1066000,1066000,1066000,1066000,1066000,1066000),
	CORE_DVFS("pll_m",   1,  1, 1, KHZ,       533000, 533000, 667000, 933000,1066000,1066000,1066000,1066000,1066000,1066000,1066000),
	CORE_DVFS("pll_c",   1,  1, 1, KHZ,       533000, 533000, 667000, 933000,1066000,1066000,1066000,1066000,1066000,1066000,1066000),
	CORE_DVFS("pll_c2",  1,  1, 1, KHZ,       533000, 533000, 667000, 933000,1066000,1066000,1066000,1066000,1066000,1066000,1066000),
	CORE_DVFS("pll_c3",  1,  1, 1, KHZ,       533000, 533000, 667000, 933000,1066000,1066000,1066000,1066000,1066000,1066000,1066000),

	CORE_DVFS("pll_d_out0",  0, -1, 1, KHZ,   408000, 408000, 667000, 800000, 1066000, 1066000, 1066000, 1066000, 1066000, 1066000, 1066000),
	CORE_DVFS("pll_d2_out0", 0, -1, 1, KHZ,   408000, 408000, 667000, 800000, 1066000, 1066000, 1066000, 1066000, 1066000, 1066000, 1066000),
	CORE_DVFS("pll_d_out0",  1,  1, 1, KHZ,   533000, 533000, 667000, 933000, 1066000, 1066000, 1066000, 1066000, 1066000, 1066000, 1066000),
	CORE_DVFS("pll_d2_out0", 1,  1, 1, KHZ,   533000, 533000, 667000, 933000, 1066000, 1066000, 1066000, 1066000, 1066000, 1066000, 1066000),

	/* Core voltages (mV):                       800,    825,    850,    900,    950,   1000,   1050,   1100,   1150,   1200,   1230 */
	/* Clock limits for IO Peripherals */
	CORE_DVFS("sbc1",   -1, -1, 1, KHZ,        33000,  33000,  33000,  33000,  30000,  30000,  50000,  50000,  50000,  50000,  50000),
	 ...
	 */
	CORE_DVFS("disp1",  -1, -1, 0, KHZ,        74250, 74250, 165000, 165000, 165000, 165000, 165000, 165000, 165000, 165000, 165000),
	CORE_DVFS("disp2",  -1, -1, 0, KHZ,        74250, 74250, 165000, 165000, 165000, 165000, 165000, 165000, 165000, 165000, 165000),
#endif
};
